...
import { initPlanningShareButton } from "./modules/share-button.js?v=20260624-personal-exit";
import { initPersonalTeamCalendar } from "./modules/personal-team-calendar.js?v=20260624-personal-exit";
...
const [{ default: App }, { h }] = await Promise.all([
  import("./App.js?v=20260624-personal-exit"),
  import("./ui.js"),
]);

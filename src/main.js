...
import { initPlanningShareButton } from "./modules/share-button.js?v=20260624-personal-fallback";
import { initPersonalTeamCalendar } from "./modules/personal-team-calendar.js?v=20260624-aux-login";
...
const [{ default: App }, { h }] = await Promise.all([
  import("./App.js?v=20260624-personal-fallback"),
  import("./ui.js"),
]);

...
import { retireInstalledApp } from "./modules/web-only.js";
...
const [{ default: App }, { h }] = await Promise.all([
  import("./App.js?v=20260726-empty-slot"),
  import("./ui.js?v=20260702-member-actions"),
]);
const root = ReactDOM.createRoot(document.getElementById("root"));
root.render(h(App));
retireInstalledApp().catch(error => console.warn("Transition vers la version web incomplète :", error));

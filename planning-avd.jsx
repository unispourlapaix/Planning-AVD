// GitHub Pages standalone runtime
...
const sS=async(k,v)=>{try{await backend().set(k,JSON.stringify(v));}catch(e){console.warn('storage.set failed',e);}};
const sL=async k=>{try{const r=await backend().get(k);return r?JSON.parse(r.value):null;}catch(e){console.warn('storage.get failed',e);return null;}};

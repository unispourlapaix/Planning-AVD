...
for (const range of ["08:00–15:00", "15:30–20:30", "20:00–22:00", "20:30–08:30 (+1 j)"]) assert.ok(html.includes(range));
assert.ok(buildCleanPlanningHtml({ ...options, startTime: "09:00" }).includes("20:00–22:00"));
